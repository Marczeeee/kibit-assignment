...
public interface InstantPaymentService {
     ...
     */
    InstantPayment makeInstantPayment(InstantPaymentRequest instantPaymentRequest) throws NoSufficientBalanceException, MissingAccountException, PaymentTransactionException;
}
